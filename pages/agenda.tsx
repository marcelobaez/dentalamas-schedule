    ...
    <>
      ...
      <Paper shadow="xs" p="md">
        ...
        <Tabs defaultValue="calendar">
          <Tabs.List>
            <Tabs.Tab value="calendar">Calendario</Tabs.Tab>
            <Tabs.Tab value="appointments">Turnos</Tabs.Tab>
          </Tabs.List>
          ...
          <Tabs.Panel value="calendar">
            <Stack pt="md">
              ...
              <Box mih={400} h={{ base: 'calc(100dvh - 250px)', sm: 'calc(100dvh - 260px)' }}>
                <FullCalendar
                        ...
                        <Text c="dimmed" fz="xs" style={{ textAlign: 'left' }}>
                          {`Pacientes hoy: ${
                            arg.resource
                              ...
                              .filter(
                                (ev) =>
                                  ev.extendedProps.type !== 'Block' &&
                                  ev.extendedProps.type !== 'Break',
                              ).length
                          }`}
                        </Text>
                      </Stack>
